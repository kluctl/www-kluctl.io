...
The first thing you need is an empty project directory and the [`.kluctl.yml`]({{< ref "docs/kluctl/reference/kluctl-project" >}}) project configuration:
...
Inside the kluctl project, you will now have to create a minimal [deployment project]({{< ref "docs/kluctl/reference/deployments" >}}).
The deployment project starts with the root [`deployment.yml`]({{< ref "docs/kluctl/reference/deployments/deployment-yml" >}}).
...
1. The list of [deployment items]({{< ref "docs/kluctl/reference/deployments/deployment-yml#deployments" >}}), which currently
only consists of the upcoming redis deployment. The next chapter will explain this deployment.
2. The [commonLabels]({{< ref "docs/kluctl/reference/deployments/deployment-yml#commonlabels" >}}), which is a map of common
