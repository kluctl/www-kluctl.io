...
images:
- "/images/blog/images/blog/2023-02-12-managing-helm-with-kluctl-cover.jpg"
---
...
The second card represents the [target]({{< ref "docs/kluctl/kluctl-project/targets" >}}). It is defined in the
