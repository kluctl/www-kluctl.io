...
[deployment.yaml](https://kluctl.io/docs/latest/kluctl/deployments/deployment-yml/) which usually just includes more
[deployment projects](https://kluctl.io/docs/latest/kluctl/deployments/) and
[items](https://kluctl.io/docs/latest/kluctl/deployments/deployment-yml/#deployments).
...
can contain plain manifests, a [Kustomize deploymnet](https://kluctl.io/docs/latest/kluctl/deployments/kustomize/)
...
has been deployed, simply put a [barrier](https://kluctl.io/docs/latest/kluctl/deployments/deployment-yml/#barriers)
between `a` and `b`:
...
The [barrier](https://kluctl.io/docs/latest/kluctl/deployments/deployment-yml/#barriers) is important here, as noted
...
deployment item, but also wait for [readiness](https://kluctl.io/docs/latest/kluctl/deployments/readiness/) of
each resource.

## Deploy it again

Simply run `kluctl deploy` again and confirm it with `y`. You should see how Kluctl deploys all resources, runs
[hooks](https://kluctl.io/docs/latest/kluctl/deployments/hooks/) and waits for readiness.
...
The next step would be to introduce [templating](https://kluctl.io/docs/latest/kluctl/reference/templating/) and
[Kluctl targets](https://kluctl.io/docs/latest/kluctl/kluctl-project/targets/). This will then allow you to make
...
then [kluctl diff](https://kluctl.io/docs/latest/kluctl/reference/commands/diff/) and unable to handle Helm Charts.
...
[targets](https://kluctl.io/docs/latest/kluctl/kluctl-project/targets/) and use templating to allow different
