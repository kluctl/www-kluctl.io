...
the [target]({{< ref "docs/latest/kluctl/kluctl-project/targets" >}}) to be deployed and some information on how
to handle kubeconfigs. The controller then regularly reconciles the deployment, meaning that it will invoke
[kluctl deploy]({{< ref "docs/latest/kluctl/commands/deploy" >}}) whenever a change is detected in the deployment.

Sounds great? Then take a look at [this]({{< ref "docs/latest/gitops" >}}) very simple example
<div class="center">
...
[targets]({{< ref "docs/latest/kluctl/kluctl-project/targets" >}}) and without templating. In Kustomize, multi-env
