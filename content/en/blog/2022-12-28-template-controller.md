...
(e.g. a Flux Helm Release or a [KluctlDeployment]({{< ref "docs/latest/gitops/spec/v1beta1/kluctldeployment" >}})).
...
[Kluctl](https://kluctl.io/docs/latest/kluctl/reference/templating/), with the `ObjectTemplate's` input matrix available as
global variables.
...
or [KluctlDeployment]({{< ref "docs/latest/gitops/spec/v1beta1/kluctldeployment" >}}). The underlying GitOps controller
